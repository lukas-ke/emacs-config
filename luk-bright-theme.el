...
(let*
  ...
  (custom-theme-set-faces
   ...
   `(compilation-mode-line-exit ((,class (:weight bold :foreground "green"))))
   `(compilation-mode-line-fail ((,class (:weight bold :foreground "violet"))))
   `(compilation-mode-line-run ((,class (:weight bold :foreground "orange"))))
